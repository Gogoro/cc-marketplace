...
3. Add all changed files with `git add -A`
4. Pull latest changes from the current branch with `git pull --rebase`
5. Read the recent commit log to understand the commit message style
6. Commit with a short, concise message summarizing the changes. If the user provided a message argument, use that instead.
